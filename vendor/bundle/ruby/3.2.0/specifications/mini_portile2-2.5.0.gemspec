...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<minitest-hooks>.freeze, ["~> 1.5.0".freeze])
  s.add_development_dependency(%q<minitar>.freeze, ["~> 0.7".freeze])
  s.add_development_dependency(%q<concourse>.freeze, ["~> 0.16".freeze])
end
